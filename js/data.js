...
const GREETINGS = {
  morning: [
    ...
    "Пятница! Время для себя. {pet} готов(-а) 🐱",
  ...
  evening: [
    ...
    "День подходит к концу. Ты сделал(-а) достаточно. Правда 💜",
...
const COMEBACK_PHRASES = [
  ...
  "Пропуск — это пауза, не конец. Ты здесь — значит не сдался(-ась) 💪",
  "{pet} загрустил(-а) вчера. Но он знает — ты вернёшься 💜",
  "Новый день. Чистый лист. Начнём? ☀️",
  "Знаешь что главное? Что ты открыл(-а) приложение. Это уже победа ✨"
];
...
const QUESTS = [
  ...
  {id:"q20", type:"good", icon:"📞", title:"Написать или позвонить кому-то первым(-ой)",
  ...
  {id:"q23", type:"good", icon:"🪞", title:"Поймал(-а) сравнение — запиши достижение",
  ...
  {id:"q28", type:"good", icon:"🛡️", title:"Защитить своё дело от чужой просьбы",
    desc:"Когда возникнет ситуация", tip:"Твой план — обещание самому(-ой) себе",
...
const INSPIRATION_CARDS = {
  creativity: [
    ...
    {id:"c8", icon:"👩‍🍳", title:"Приготовь по новому рецепту",
      desc:"Найди рецепт чего-то чего никогда не готовил(-а). Приготовь прямо сейчас или запланируй на сегодня.",
  ...
  care: [
    ...
    {id:"ca7", icon:"💬", title:"Напиши кому-то скучаю",
      desc:"Тому кому давно не писал(-а). Одно сообщение.",
      tip:"Поддержание связей требует активных действий", time:2, coins:3, stat:"charisma"},
    {id:"ca8", icon:"🕊️", title:"Прости себе одну вещь",
      desc:"Что-то за что ругаешь себя. Скажи себе: я делал(-а) лучшее что мог(-ла) тогда.",
  ...
  explore: [
    ...
    {id:"e2", icon:"🎼", title:"10 мин музыки нового жанра",
      desc:"Жанр который никогда не слушал(-а). Джаз, фолк, босанова, k-pop.",
    ...
    {id:"e5", icon:"🍜", title:"Попробуй еду которую не ел(-а)",
    ...
    {id:"e7", icon:"👥", title:"Узнай что-то новое о человеке рядом",
      desc:"Спроси что-то что никогда не спрашивал(-а): любимое детское воспоминание, мечта.",
