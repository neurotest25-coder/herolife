...
var BOSSES = [
  {
    ...
    story: "Ты знаешь это чувство.\nПроснуться, сделать то же что вчера, лечь спать.\nПовторить. И так — месяцами.\nОн не враг — он привычка.\nНо сегодня ты его {увидела|увидел}.",
  ...
  },
  {
    ...
    story: "«Не сейчас. Завтра. Когда будет настроение.»\nЗнакомо?\nЭтот лёд нарастает каждый день.\nНо у тебя уже есть тепло.\nВремя растопить.",
  ...
  },
  {
    ...
    story: "Она не кричит. Не требует.\nОна просто забирает цвета.\nУтром тяжело встать.\nВечером — ничего не хочется.\nЭто не лень. Это истощение.\nПора научиться отдыхать.",
  ...
  },
  {
    ...
    story: "«А вдруг не получится?»\n«А что подумают?»\n«А может не стоит и начинать?»\nКаждая мысль — новая нить.\nЧем больше думаешь, тем крепче паутина.\nВремя разорвать.",
  ...
  },
  {
    ...
    story: "Она выглядит как ты.\nГоворит твоим голосом:\n«Тебе просто повезло.\nСкоро все поймут, что ты притворяешься.»\n{Слышала|Слышал} этот голос раньше?\nПора посмотреть ей в глаза.",
  ...
  },
  {
    ...
    story: "Эту стену ты {построила|построил} {сама|сам}.\nКирпич за кирпичом.\n«Так безопаснее. Так не больно.»\nНо за стеной — одиноко.\nИ никто не может войти.\nПора открыть дверь.",
  ...
  },
  {
    ...
    story: "Она была такой же, как ты.\n{Хотела|Хотел} меняться — и {меняла|менял}.\nПотом {решила|решил}, что ничего не имеет смысла.\nСерая Королева — это ты через 10 лет, если сдашься.\nНо ты не сдашься.",
    victoryText: {
  ...
  BOSSES.forEach(function(boss) {
    ...
    card.innerHTML =
      "<div class=\"boss-card-title\" style=\"text-align:center;\">" + boss.emoji + " " + boss.name + "</div>" +
        "<div class=\"boss-card-region\" style=\"text-align:center;\">" + boss.region + "</div>" +
  "<div class=\"boss-card-status\" style=\"text-align:center;\">" + statusText + "</div>" +
  "<div class=\"boss-card-reqs\" style=\"text-align:center;\">" + reqStr + "</div>";
