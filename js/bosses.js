...
var BOSSES = [
  {
    ...
    victoryText: "Туман рассеивается. Мир яркий, живой. Впервые ты чувствуешь, что по-настоящему проснулась.",
    defeatText: "Туман густеет. Нужно больше энергии и дисциплины, чтобы пробиться сквозь него.",
    reward: { title: "Пробудившаяся", coins: 50, special: null },
    defeated: false
  },
  {
    id: 2,
    ...
    reward: { title: "Сокрушительница Льда", coins: 75, special: null },
    defeated: false
  },
  {
    id: 3,
    ...
    reward: { title: "Познавшая Тишину", coins: 100, special: "День отдыха — раз в неделю пропуск без потери streak" },
    defeated: false
  },
  {
    id: 4,
    ...
    reward: { title: "Разрубившая Узел", coins: 100, special: null },
    defeated: false
  },
  {
    id: 5,
    ...
    story: "Твоя копия говорит твоим голосом. Тебе просто повезло — скоро все поймут, что ты самозванка. Ты слышала этот голос раньше?",
    victoryText: "Зеркала трескаются. Самозванка улыбается — наконец ты поверила в себя. Она была только отражением страха.",
    defeatText: "Отражения множатся. Прокачай харизму, здоровье и интеллект — поверь в себя.",
    reward: { title: "Подлинная", coins: 125, special: "уникальная рамка аватара" },
    defeated: false
  },
  {
    id: 6,
  ...
  },
  {
    ...
    story: "Она была такой же, как ты. Хотела меняться и меняла. Потом устала и решила, что ничего не имеет смысла. Серая Королева — это ты через 10 лет, если сдашься.",
    victoryText: {
    ...
    reward: {
      ...
      titleAngel: "Светлая Королева",
      titleDevil: "Тёмная Императрица",
      titleBalance: "Хранительница Баланса",
      coins: 500,
